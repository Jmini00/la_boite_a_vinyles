...
<head>
    ...
    <meta name="description" content="Collection Liam Gallagher - La Boite à Vinyles">
    <title>Collection Liam Gallagher - La Boite à Vinyles</title>
...
<div id="side-nav">
    ...
    <header>
        ...
        <div id="banner" class="align-vertical">
            <img class="banner-img" src="../assets/slides/collection.webp" alt="illustration collection vinyles">
