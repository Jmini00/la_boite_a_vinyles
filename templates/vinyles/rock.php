...
<head>
    ...
    <meta name="description" content="Collection Rock - La Boite à Vinyles">
    <title>Collection Rock - La Boite à Vinyles</title>
...
<div id="side-nav">
    ...
    <header>
        ...
        <div id="banner" class="align-vertical">
            <img class="banner-img" src="../assets/slides/bar.webp" alt="illustration collection vinyles">
