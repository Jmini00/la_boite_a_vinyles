...
<head>
    ...
    <meta name="description" content="Collection God save the King - La Boite à Vinyles">
    <title>Collection God save the King - La Boite à Vinyles</title>
...
<div id="side-nav">
    ...
    <header>
        ...
        <div id="banner" class="align-vertical">
            <img class="banner-img" src="../assets/slides/collection_2.webp" alt="illustration collection vinyles">
    ...
    <main>
        ...
        <section class="all-vinyls">
            <h3>Collection God save the King</h3>
